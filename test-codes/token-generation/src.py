def grant_admin_access(name, pwd):
    	redirect_to_admin_panel(name, pwd)

def grant_guest_access(username = 'guest', password = 'guest'):
    	redirect_to_user_options(name, pwd)

username = 'admin'
password = 'admin'

if username  == 'admin' and password == 'admin':
            grant_admin_access(username, password)

else: grant_guest_access(username = 'guest', password = 'guest')
